...
|序列|特征|描述|优先级|状态|
|----|----|----|----|----|
|1|BUG|安卓手机上查看头像显示不规则|10|未解决|
|2|BUG|input获取光标后，fixed定位的nav导航栏会被顶上去|7|未解决|
|3|BUG|上门保养也没的输入时间和手机号码两处需要修改|10|未解决|
|4|BUG|点击document的区域应该让导航nav展示部分消失|9|未解决|
|5|BUG|驾管服务的首页菜单在部分安卓机表现出高度不一致问题|10|未解决|
|6|BUG|所有a和li元素的outline问题|8|未解决|
|7|BUG|上门保养列表页a的高度|9|未解决|
|8|BUG|我的订单处的icon没有|9|未解决|
